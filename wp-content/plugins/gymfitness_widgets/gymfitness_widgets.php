...
/*
    Plugin Name: Gymfitness - Widget
    Plugin URI:
    Description: Añade widgets personalizado al sitio GymFitness
    Version: 1.0.0
    Author: Edgar Ortega
    Autor URI:
...
class Gymfitness_clases_widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<ul>
            <?php //consulta sql
               $cantidad = $instance['cantidad'];//guardado desde form
                $args = array( 
                ...
                <li class="clase-sidebar">
                    ...
                    <div class="contenido-clase">
                        ...
                        <?php 
                            ...
                            $hora_final=get_field('hora_fin');
                        ?>
                        <p><?php the_field('dias_clase');?> - <?php echo $hora_inicio . " a ". $hora_final;?></p>
                    </div>
                </li>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'cantidad'));?>">
                <?php esc_attr_e( 'Cuantas clases deseas mostar?', 'gymfitness');?>
            </label>
            <input 
                class="widefat"
